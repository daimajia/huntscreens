        ...
        <div className=' w-full flex flex-col gap-4 px-5 md:mt-5'>
          <div className='flex flex-col justify-center items-center'>
            <h1 className=' relative text-center lg:leading-[3.5rem] font-bold text-slate-800 dark:text-gray-100 text-2xl md:mt-3 md:text-5xl leading-10'>
              <span className='relative inline-block'>Visually<Image alt="" className='w-28 md:w-52' src={underline} /></span>Discover  Latest <br /> <span className='bg-clip-text text-transparent bg-gradient-to-br from-amber-500 to-pink-500'>Products and Startups</span>
            </h1>
