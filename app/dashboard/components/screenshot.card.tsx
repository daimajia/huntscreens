    ...
    <div className={`flex flex-col gap-5 hover:bg-muted p-3 rounded-lg transition hover:cursor-pointer`}>
      <div>
        <Link href={`/p/${props.producthunt.id}`}>
          <img alt="" loading="lazy" className=" h-[40vh] object-cover object-top w-full rounded-t-lg border-muted border" src={`${process.env.NEXT_PUBLIC_CLOUDFLARE_R2}/${props.producthunt.uuid}.webp` || ""}></img>
        </Link>
      </div>
