    ...
    <div className="grid grid-cols-2 md:grid-cols-3 justify-between py-4 px-4 md:px-10  sticky top-0 z-50 border-b dark:border-none  navbar bg-base-100  bg-background">
      ...
      <div className="hidden lg:flex flex-row gap-5 items-center text-sm">
        ...
        <div className="flex flex-row justify-center items-center gap-1">
          <Link href="/" title="ProductHunt" className="hover:underline relative flex flex-row gap-1 justify-center items-center">
            <img src="/phlogo.png" alt="" className=" h-10" />
            <span className="hidden 2xl:flex">ProductHunt</span>
          </Link>
        ...
        <div className="flex flex-row justify-center items-center gap-1">
          <Link href="/indiehackers" title="IndieHackers" className="hover:underline relative flex flex-row gap-1 justify-center items-center">
            <img src="/indiehackers.jpg" alt="" className=" h-7 rounded-full" />
            <span className="hidden 2xl:flex">IndieHackers</span>
          </Link>
        ...
        <div className="flex flex-row items-center justify-center gap-1">
          <Link href="/startup/yc" title="Y Combinator" className="hover:underline relative flex flex-row gap-1 justify-center items-center">
            <img src="/yc.png" alt="" className="h-7 rounded-full" />
            <span className="hidden 2xl:flex">YCombinator</span>
          </Link>
